          ...
          <form onSubmit={handleSave} className="p-6 flex flex-col gap-4 text-left">
            ...
            <div className="flex gap-3 pt-2 border-t border-white/10 mt-2">
              ...
              <button 
                ...
                className="flex-1 py-2 bg-neon-purple text-btn-text-accent font-bold rounded-xl text-sm hover:shadow-[0_0_20px_rgba(168,85,247,0.5)] transition-all flex items-center justify-center gap-1.5 disabled:opacity-50"
              >
                {isSavingState ? (
                  <>
